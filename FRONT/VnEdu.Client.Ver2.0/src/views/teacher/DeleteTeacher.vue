<template>
    <div class="t-dialog" v-show="isShowDeleteTeacher">
        <div class="m-form">
...
export default {
    ...
    methods: {
         ...
         */
        clickBtnNo(){
            this.isShowDeleteTeacher = !this.isShowDeleteTeacher;
        },
        /**
         * click Btn có
         * CreatedBy: MinhVN(28/01/2022)
        ...
        clickBtnYes(){
            var m = this;
            axios
            .delete(`${m.URLAPI}/api/v1/Teachers/${m.teacherId}`,
            ...
            .then(function(response){
                ...
                { 
                    ...
                    m.isShowDeleteTeacher = !m.isShowDeleteTeacher;
                }
            })
            .catch(function(res){
                console.log(res);
    ...
    created() {
        var  m = this;
        eventBus.$on("isShowDeleteTeacherWas", (isShowDeleteTeacherData) =>{
            m.isShowDeleteTeacher = isShowDeleteTeacherData;
        });
